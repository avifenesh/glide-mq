...
- **Coverage**: integration-first V8 coverage on the fork (`ci/ts-coverage`). Lua extract + in-Valkey Lua coverage are follow-up PRs. Codecov project status is informational; patch target 80%.
