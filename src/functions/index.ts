...
/* v8 ignore start -- coverage job uses a distinct version so src-imported clients do not REPLACE the instrumented library */
export const LIBRARY_VERSION = process.env.GLIDEMQ_LUA_COVERAGE === '1' ? '93-cov' : '93';
